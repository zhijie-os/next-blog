...
const headerNavLinks: { title: string; href: string }[] = [{ title: "HOME", href: "/" }, { title: "DEV", href: "/dev" }, {title:"LIFE", href:"/life"}, { title: "PROJECT", href: "/projects" },  {title:"GALLERY", href:"/gallery"}]
