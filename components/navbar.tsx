...
const headerNavLinks: { title: string; href: string }[] = [{ title: "HOME", href: "/" }, { title: "BLOG", href: "/posts" }, { title: "PROJECT", href: "/projects" }, {title:"PUBLICATION", href:"/publication"},  {title:"GALLERY", href:"/gallery"}]
